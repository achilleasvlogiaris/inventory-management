export default {
  ...
  restocking: {
    title: 'Restocking',
    description: 'Get budget-driven restock recommendations from demand forecasts',
    budget: {
    ...
    orderSuccess: 'Order {orderNumber} placed successfully. Estimated lead time: {leadTime} days.'
  },
